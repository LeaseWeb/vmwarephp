...
class ServiceTest extends PHPUnit_Framework_TestCase
{
    ...
    function testRetrievesAPropertyForAManagedObjectUsingThePropertyCollector()
    {
        ...
        $this->assertEquals(
            'someConfigStatus',
            $this->vmWareService->__call('getConfigStatus', array($aManagedObject))
        );
    }
    ...
    {
        return new \Vmwarephp\ManagedObject(
            $this->vmWareService, new ManagedObjectReference('vm151', 'VirtualMachine')
        );
    }
